...
def plot_havoc_rate(position: str, snaps_threshold: int):
    ...
    title = f"2023 NFL {position_names[position]} Havoc Rate"
    ...
    plot_path = os.path.join(PLOTS_FOLDER_PATH, f'{position} Havoc Rate.jpeg')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close('all')


if __name__ == "__main__":
    plot_havoc_rate('DI', 170)
