...
def plot_win_rate(season: int, position: str, snaps_threshold: int):
    ...
    title = f"{season} NFL {position_names[position]} Pass Rush Win Rate"
    ...
    plot_path = os.path.join(PLOTS_FOLDER_PATH, f'{season} {position} Pass Rush Win Rate.jpeg')
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close('all')


if __name__ == "__main__":
    plot_win_rate(2023, 'DI', 170)
